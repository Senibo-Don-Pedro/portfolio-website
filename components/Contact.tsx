...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: "Email",
      value: "senibodonpedro@gmail.com",
      link: "mailto:senibodonpedro@gmail.com",
    },
    {
      icon: <Phone className="h-5 w-5" />,
      label: "Phone",
      value: "+234 808 075 8943",
      link: "tel:+2348080758943",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      label: "LinkedIn",
      value: "senibo-don-pedro",
      link: "https://www.linkedin.com/in/senibo-don-pedro",
    },
    {
